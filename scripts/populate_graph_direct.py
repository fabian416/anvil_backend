...
PROTOCOLS = [
    ...
    },
    {
        ...
        "tvl": 3200000000,
        "risk_score": 3.0,
        "description": "MakerDAO lending protocol fork of Aave",
    },
    {
        "name": "Radiant",
        "category": "Lending",
    ...
    },
    {
        ...
        "tvl": 400000000,
        "risk_score": 3.5,
        "description": "Curve overcollateralized stablecoin",
    },
    # Derivatives (6)
    {
        "name": "GMX",
...
async def main():
    ...
    if not result:
        ...
        await conn.execute("SELECT create_graph('defi_knowledge_graph')")
        print("✅ Graph created")
    else:
        print("✅ Graph exists")
