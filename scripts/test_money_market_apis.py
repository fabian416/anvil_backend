...
async def test_defillama():
    ...
    try:
        ...
        if aave_yields:
            ...
            base_usdc = [
                y
                for y in aave_yields
                if y.chain.lower() == "base" and "usdc" in y.symbol.lower()
            ]
            print(
                f"✅ Found {len(aave_yields)} Aave pools, {len(base_usdc)} on Base with USDC"
            )
        ...
        if compound_yields:
            ...
            print(
                f"✅ Found {len(compound_yields)} Compound pools, {len(base_yields)} on Base"
            )
        ...
        if morpho_yields:
            ...
            print(
                f"✅ Found {len(morpho_yields)} Morpho pools, {len(base_yields)} on Base"
            )
