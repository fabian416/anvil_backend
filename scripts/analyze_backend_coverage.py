...
class BackendAnalyzer:
                        ...
                        if match:
                            ...
                            endpoints.append(
                                APIEndpoint(
                                    ...
                                    path=path,
                                    file_path=str(
                                        file_path.relative_to(self.backend_root)
                                    ),
    ...
    def generate_report(self) -> str:
        ...
        total_entities = len(
            set(e for f in self.features.values() for e in f.domain_entities)
        )
        ...
        lines.append(
            f"   • Total Routers: {sum(len(f.routers) for f in self.features.values())}"
        )
        lines.append("")
