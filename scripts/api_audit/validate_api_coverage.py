...
class APICoverageValidator:
    ...
    def __init__(self, project_root: Path):
        ...
        self.backend_inventory_path = project_root / "scripts" / "api_audit" / "data" / "backend_inventory.json"
        self.docs_dir = project_root / "docs" / "frontend"
        
        # Priority classification
        self.critical_paths = [
            r'/account/', r'/auth/', r'/payment/', r'/subscription/',
            r'/ws/', r'/notifications/', r'/preferences/', r'/alerts/',
            r'/search/', r'/dashboard/', r'/markets/', r'/portfolio/',
            r'/comparison/', r'/chat/', r'/projects/'
        ]
        
        self.high_priority_paths = [
            r'/admin/projects', r'/admin/distillation', r'/admin/stats',
            r'/admin/agents', r'/atlas/', r'/metrics/'
        ]
    ...
    def scan_documentation(self) -> Set[str]:
        ...
        endpoint_pattern = re.compile(r'(?:GET|POST|PUT|PATCH|DELETE|WS)\s+(/api/v1/[^\s\n]+)')
