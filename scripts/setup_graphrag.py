...
async def populate_graph(session, limit: int | None = None):
    ...
    from app.infrastructure.persistence_age.graph_repository_age import (
        GraphRepositoryAge,
    )
        ...
        async def get_all_protocols(self, limit: int | None = None):
            ...
            protocols = [
                ...
                ProtocolData(
                    ...
                    tvl=10_500_000_000,
                    description="Leading decentralized lending protocol with flash loans",
                ...
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=3_200_000_000,
                    description="MakerDAO's lending protocol fork of Aave",
                    website="https://spark.fi",
                    audit_links=["ChainSecurity", "Cantina"],
                    token_symbol="SPK",
                    change_24h=1.8,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    chains=["BSC"],
                    tvl=800_000_000,
                    description="BSC lending protocol",
                    website="https://venus.io",
                    audit_links=["Certik", "Peckshield"],
                    token_symbol="XVS",
                    change_24h=0.5,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    chains=["Avalanche"],
                    tvl=200_000_000,
                    description="Avalanche native lending",
                ...
                ProtocolData(
                    ...
                    tvl=120_000_000,
                    description="Isolated risk lending markets",
                    website="https://silo.finance",
                    audit_links=["Quantstamp"],
                    token_symbol="SILO",
                    change_24h=2.3,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    chains=["Ethereum", "Arbitrum"],
                    tvl=80_000_000,
                    description="Fixed rate lending protocol",
                    website="https://notional.finance",
                    audit_links=["OpenZeppelin", "Code4rena"],
                    token_symbol="NOTE",
                    change_24h=1.5,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    tvl=300_000_000,
                    description="Multi-chain AMM DEX",
                    website="https://sushi.com",
                    audit_links=["Peckshield", "Quantstamp"],
                    token_symbol="SUSHI",
                    change_24h=0.3,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    audit_links=["Trail of Bits", "OpenZeppelin"],
                    token_symbol="BAL",
                    change_24h=1.8,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    audit_links=["OpenZeppelin", "Decurity"],
                    token_symbol="1INCH",
                    change_24h=-0.2,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    tvl=1_500_000_000,
                    description="Multi-chain DEX with farming",
                ...
                ProtocolData(
                    ...
                    chains=["Optimism"],
                    tvl=200_000_000,
                    description="Optimism native ve(3,3) DEX",
                    website="https://velodrome.finance",
                    audit_links=["Spearbit"],
                    token_symbol="VELO",
                    change_24h=3.5,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    chains=["Base"],
                    tvl=500_000_000,
                    description="Base native ve(3,3) DEX",
                ...
                ProtocolData(
                    ...
                    chains=["Arbitrum"],
                    tvl=100_000_000,
                    description="Arbitrum native DEX with NFT incentives",
                ...
                ProtocolData(
                    ...
                    tvl=120_000_000,
                    description="Multi-chain DEX with Liquidity Book",
                    website="https://traderjoexyz.com",
                    audit_links=["Omniscia"],
                    token_symbol="JOE",
                    change_24h=0.8,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    audit_links=["Quantstamp", "MixBytes", "Statemind"],
                    token_symbol="LDO",
                    change_24h=0.8,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    audit_links=["Sigma Prime", "Trail of Bits"],
                    token_symbol="RPL",
                    change_24h=-0.5,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=1_200_000_000,
                    description="Frax liquid staking derivative",
                ...
                ProtocolData(
                    ...
                    tvl=600_000_000,
                    description="Mantle ecosystem liquid staking",
                    website="https://mantle.xyz",
                    audit_links=["OpenZeppelin"],
                    token_symbol="MNT",
                    change_24h=0.3,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    tvl=150_000_000,
                    description="Multi-chain liquid staking",
                ...
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=200_000_000,
                    description="Non-custodial ETH staking",
                    website="https://stakewise.io",
                    audit_links=["Quantstamp", "Runtime Verification"],
                    token_symbol="SWISE",
                    change_24h=0.7,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    audit_links=["Halborn", "Peckshield"],
                    token_symbol="SD",
                    change_24h=1.1,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=500_000_000,
                    description="Interest-free borrowing against ETH",
                    website="https://liquity.org",
                    audit_links=["Trail of Bits", "Coinspect"],
                    token_symbol="LQTY",
                    change_24h=-0.8,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    website="https://frax.finance",
                    audit_links=["Trail of Bits", "Certik"],
                    token_symbol="FXS",
                    change_24h=1.5,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=200_000_000,
                    description="LST-backed stablecoin",
                    website="https://prismafinance.com",
                    audit_links=["MixBytes"],
                    token_symbol="PRISMA",
                    change_24h=2.1,
                    raw_data={},
                ),
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=400_000_000,
                    description="Curve's overcollateralized stablecoin",
                    website="https://curve.fi",
                    audit_links=["MixBytes", "ChainSecurity"],
                    token_symbol="CRV",
                    change_24h=0.5,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    audit_links=["Iosiro", "Sigma Prime"],
                    token_symbol="SNX",
                    change_24h=-0.3,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    audit_links=["Trail of Bits", "MixBytes"],
                    token_symbol="YFI",
                    change_24h=-0.5,
                    raw_data={},
                ),
                ...
                ProtocolData(
                    ...
                    slug="beefy",
                    category="Yield",
                    chains=["BSC", "Polygon", "Arbitrum", "Optimism"],
                    tvl=150_000_000,
                ...
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=100_000_000,
                    description="Active DeFi strategy vaults",
                ...
                ProtocolData(
                    ...
                    tvl=50_000_000,
                    description="Token bridge for rollups",
                ...
                ProtocolData(
                    ...
                    chains=["Ethereum"],
                    tvl=15_000_000_000,
                    description="Restaking for shared security",
                    website="https://eigenlayer.xyz",
                    audit_links=["Sigma Prime", "ChainSecurity"],
                    token_symbol="EIGEN",
                    change_24h=1.8,
                    raw_data={},
                ),
...
async def main():
    ...
    parser.add_argument(
        "--populate", action="store_true", help="Populate graph with protocol data"
    )
    parser.add_argument(
        "--limit", type=int, default=None, help="Limit number of protocols to populate"
    )
    parser.add_argument(
        "--validate", action="store_true", help="Validate graph structure"
    )
