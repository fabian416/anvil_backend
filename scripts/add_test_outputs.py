...
def generate_agent_content(test_case: Dict[str, Any], category: str, subcategory: str) -> str:
...
def generate_enrichment_data(test_case: Dict[str, Any], category: str, subcategory: str) -> Dict[str, Any]:
    ...
    if category == 'graphrag' and subcategory == 'protocol_search':
        ...
        if 'search_context' not in base_enrichment:
            base_enrichment['search_context'] = "Found protocols matching your search criteria"
        if 'recommendations' not in base_enrichment:
            base_enrichment['recommendations'] = ["Consider diversifying across protocols"]
