#!/bin/bash
# moonpay_swap_test.sh - FIXED (SOLO QUOTES)
echo "🚀 === MOONPAY SWAPS V4 QUOTE TEST ==="
API_KEY="pk_test_O4n4ZPtiXBbuOkeME1s0dhrE8iftXOG"  # Tu API key
PAIR="eth-btc"
AMOUNT="0.4"
...
QUOTE_RESPONSE=$(curl -s "https://api.moonpay.com/v4/swap/$PAIR/quote?apiKey=$API_KEY&baseCurrencyAmount=$AMOUNT")
