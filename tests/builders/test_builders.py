...
class TestConversationBuilder:
    ...
    def test_builder_is_fluent(self):
        ...
        conversation = (
            a_conversation().with_user_id(123).with_title("Test").build_dict()
        )
...
class TestMessageBuilder:
    ...
    def test_build_system_message(self):
        ...
        # Act
        message = (
            a_message().from_system().with_content("System notification").build_dict()
        )
...
class TestBuilderUsageExamples:
    ...
    def test_create_user_with_conversations(self):
        ...
        conversation1 = (
            a_conversation().with_user_id(user_id).with_title("Chat 1").build_dict()
        )

        conversation2 = (
            a_conversation().with_user_id(user_id).with_title("Chat 2").build_dict()
        )
