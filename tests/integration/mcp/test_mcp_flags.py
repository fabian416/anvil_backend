...
class TestDeFiLlamaServerFlags:
    ...
    def test_defillama_can_be_disabled(self):
        ...
        settings = MCPSettings(servers=MCPServerSettings(defillama_enabled=False))
...
class TestOneInchServerFlags:
    ...
    def test_oneinch_can_be_disabled(self):
        ...
        settings = MCPSettings(servers=MCPServerSettings(oneinch_enabled=False))
...
class TestTheGraphServerFlags:
    ...
    def test_thegraph_can_be_disabled(self):
        ...
        settings = MCPSettings(servers=MCPServerSettings(thegraph_enabled=False))
...
class TestCoinGeckoServerFlags:
    ...
    def test_coingecko_can_be_disabled(self):
        ...
        settings = MCPSettings(servers=MCPServerSettings(coingecko_enabled=False))
...
class TestAaveServerFlags:
    ...
    def test_aave_can_be_disabled(self):
        ...
        settings = MCPSettings(servers=MCPServerSettings(aave_enabled=False))
...
class TestPortfolioServerFlags:
    ...
    def test_portfolio_can_be_disabled(self):
        ...
        settings = MCPSettings(servers=MCPServerSettings(portfolio_enabled=False))
