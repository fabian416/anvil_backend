...
class TestGuestHunterSentiment:
    ...
    @pytest.mark.asyncio
    async def test_sentiment_analysis_basic(self, client):
    ...
    @pytest.mark.asyncio
    async def test_sentiment_multiple_tokens(self, client):
    ...
    @pytest.mark.asyncio
    async def test_sentiment_classification_types(self, client):
    ...
    @pytest.mark.asyncio
    async def test_sentiment_multilingual_spanish(self, client):
    ...
    @pytest.mark.asyncio
    async def test_sentiment_real_data_sources(self, client):
...
class TestGuestHunterSentimentStorytellingQuality:
    ...
    @pytest.mark.asyncio
    async def test_sentiment_uses_emojis(self, client):
    ...
    @pytest.mark.asyncio
    async def test_sentiment_clear_formatting(self, client):
    ...
    @pytest.mark.asyncio
    async def test_sentiment_actionable_insights(self, client):
