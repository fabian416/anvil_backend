...
class TestHistoricalChatDataIntegrity:
    ...
    async def test_empty_conversation_history(self, client: AsyncClient, llm_validator):
        """
    ...
    @pytest.mark.llm_validation
    async def test_deleted_message_handling(self, client: AsyncClient, llm_validator):
        """
