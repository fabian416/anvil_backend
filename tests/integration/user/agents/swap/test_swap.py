...
Migrated from: tests/integration/user/workflows/test_swap_workflow.py
"""
...
SWAP_TESTS = [
    ...
    # Multi-Language: Spanish (from shortcuts.md)
    {
        "test_id": "swap_es_001",
        "input": "cambiar 100 USDC a PURR",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_spanish",
    },
    {
        "test_id": "swap_es_002",
        "input": "intercambiar 50 USDC por TRUMP",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_spanish",
    },
    # Multi-Language: Portuguese (from shortcuts.md)
    {
        "test_id": "swap_pt_001",
        "input": "trocar 100 USDC para PURR",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_portuguese",
    },
    # Multi-Language: Chinese (from shortcuts.md)
    {
        "test_id": "swap_zh_001",
        "input": "兑换 100 USDC 到 PURR",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_chinese",
    },
    # Token Selection Flow
    {
        "test_id": "swap_selection_001",
        "input": "swap 100 USDC",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_selection",
    },
    # Unsupported Token Handling
    {
        "test_id": "swap_unsupported_001",
        "input": "swap ETH to SOL",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_unsupported",
    },
    {
        "test_id": "swap_non_usdc_001",
        "input": "swap PURR to TRUMP",
        "expected_agent": "swap_workflow",
        "category": "workflow",
        "subcategory": "swap_unsupported",
    },
    # Information Patterns (should route to hunter_ai, not swap_workflow)
    {
        "test_id": "swap_info_001",
        "input": "best swap rate ETH to USDC",
        "expected_agent": "hunter_ai",
        "category": "workflow",
        "subcategory": "swap_info_distinction",
    },
    {
        "test_id": "swap_info_002",
        "input": "price of PURR",
        "expected_agent": "hunter_ai",
        "category": "workflow",
        "subcategory": "swap_info_distinction",
