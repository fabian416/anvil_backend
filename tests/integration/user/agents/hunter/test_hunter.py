...
Migrated from: tests/integration/user/agents/test_hunter_ai.py
"""
...
HUNTER_AI_TESTS = [
    ...
    # Swap Rate Queries (from shortcuts.md - routes to hunter_ai NOT swap_workflow)
    {
        "test_id": "hunter_rate_001",
        "input": "swap rate ETH to USDC",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_rates",
    },
    {
        "test_id": "hunter_rate_002",
        "input": "best rate for ETH to USDC",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_rates",
    },
    {
        "test_id": "hunter_rate_003",
        "input": "exchange rate ETH/USDC",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_rates",
    },
    ...
    {
        "test_id": "hunter_whale_002",
        "input": "large transactions ETH",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_whale",
    },
    ...
    {
        "test_id": "hunter_es_001",
        "input": "precio de ETH",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_spanish",
    },
    {
        "test_id": "hunter_es_002",
        "input": "precios de BTC y ETH",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_spanish",
    },
    ...
    {
        "test_id": "hunter_pt_001",
        "input": "preço de ETH",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_portuguese",
    },
    
    # Multi-Language: Chinese
    {
        "test_id": "hunter_zh_001",
        "input": "ETH的价格",
        "expected_agent": "hunter_ai",
        "category": "agent",
        "subcategory": "hunter_chinese",
    },
]
