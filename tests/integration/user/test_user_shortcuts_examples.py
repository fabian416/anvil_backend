...
async def conversation_id(client: AsyncClient):
    ...
    response = await client.get(
        ...
        headers={{"Authorization": f"Bearer {eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRoX3Nlc3Npb25faWQiOiJXOUpZbHJpLUJkTG5aUDlvNXYwaGFoRkxQdmhVM2U4VXhIZl9CMkRRMnZJIiwiZXhwIjoxNzY3ODI1MzQ1fQ.Xd3k7h7LZOVXNxLUg4nGfNeKOhmVup3S-8D8VqxhHuI}"},
    )
