...
async def conversation_id(client: AsyncClient):
    ...
    response = await client.get(
        ...
        headers={{"Authorization": f"Bearer {eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRoX3Nlc3Npb25faWQiOiIxT01zYm1wNHpkZnRfYzBjLXhGUXdVUXNQLTVINXNCV0ZySjA3aVF2eGtrIiwiZXhwIjoxNzY3ODIxMDYwfQ.uUTpt-Q2N-JmG2laF_iekZjY3LV3XNOutajOBwX-oqI}"},
    )
