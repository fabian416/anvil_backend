...
class TestLogoutFlow:
    ...
    async def test_logout_with_valid_session_succeeds(self, client):
        """
    ...
    async def test_logout_without_authentication_fails(self, client):
        """
    ...
    async def test_logout_with_invalid_token_fails(self, client):
        """
    ...
    async def test_logout_returns_no_content(self, client):
        """
...
class TestLogoutSessionInvalidation:
    ...
    async def test_refresh_token_rejected_after_logout(self, client):
        """
        WHEN user logs out
...
class TestMultipleSessionLogout:
    ...
    async def test_logout_only_affects_current_session(self, client):
        """
    ...
    async def test_logout_all_sessions(self, client):
        """
...
class TestLogoutErrorHandling:
    ...
    async def test_logout_with_expired_token(self, client):
        """
    ...
    async def test_logout_error_response_format(self, client):
        """
        WHEN logout fails
