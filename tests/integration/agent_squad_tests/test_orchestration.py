...
class TestAgentOrchestration:
    ...
    async def test_route_to_chat_agent(
    ...
    @pytest.mark.llm_validation
    async def test_route_to_hunter_ai_agent(
        self, mock_intent_classifier, mock_feature_flags
    ):
    ...
    async def test_fallback_to_chat_on_low_confidence(
        ...
        mock_intent_classifier.classify.return_value.confidence = (
    ...
    @pytest.mark.llm_validation
    async def test_disabled_agent_fallback(
        self, mock_intent_classifier, mock_feature_flags
    ):
        ...
        mock_intent_classifier.classify.return_value.agent_type = (
