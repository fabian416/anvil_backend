...
class TestActivateUser:
    ...
    async def test_admin_can_activate_user(self, client):
        """
    ...
    async def test_activate_already_active_user(self, client):
        """
    ...
    async def test_activate_nonexistent_user(self, client):
        """
...
class TestDeactivateUser:
    ...
    async def test_admin_can_deactivate_user(self, client):
        """
    ...
    async def test_deactivate_already_inactive_user(self, client):
        """
    ...
    async def test_cannot_deactivate_self(self, client):
        """
...
class TestAdminPasswordChange:
    ...
    async def test_admin_can_change_user_password(self, client):
        """
    ...
    async def test_non_admin_cannot_change_user_password(self, client):
        """
    ...
    async def test_change_password_nonexistent_user(self, client):
        """
    ...
    async def test_change_password_weak_password(self, client):
        """
...
class TestUserStatusErrorResponses:
    ...
    async def test_activate_returns_proper_error_format(self, client):
        """
    ...
    async def test_deactivate_returns_proper_error_format(self, client):
        """
