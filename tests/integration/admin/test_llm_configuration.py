...
class TestLLMProviders:
    ...
    def test_admin_can_list_providers(self, client):
        """
    ...
    def test_non_admin_cannot_list_providers(self, client):
        """
...
class TestLLMModels:
    ...
    def test_admin_can_list_models(self, client):
        """
    ...
    def test_disable_model(self, client):
        """
...
class TestLLMRanking:
    ...
    def test_get_carousel_order(self, client):
        """
        WHEN admin requests carousel order
        THEN system SHALL return ranking (or 401 if not authenticated)
        """
        response = client.get("/api/v1/admin/llm/rankings")

        assert response.status_code in (200, 401, 403)

    def test_update_carousel_order(self, client):
        """
...
class TestAgentModelConfig:
    ...
    def test_get_agent_config(self, client):
        ...
        """
        response = client.get("/api/v1/admin/llm/agent-config")
...
class TestLLMTelemetry:
    ...
    def test_get_telemetry(self, client):
        ...
        """
        response = client.get("/api/v1/admin/llm/telemetry")

        assert response.status_code in (200, 401, 403)

    def test_get_telemetry_with_date_range(self, client):
        """
...
class TestLLMBudgets:
    ...
    def test_get_budgets(self, client):
        ...
        """
        response = client.get("/api/v1/admin/llm/budgets")
...
class TestLLMCircuitBreakers:
    ...
    def test_get_circuit_status(self, client):
        ...
        """
        response = client.get("/api/v1/admin/llm/circuit-breakers")
