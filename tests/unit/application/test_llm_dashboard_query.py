...
class TestDashboardDataValidation:
    ...
    async def test_top_models_ranking(self):
        ...
        assert ranks == list(range(1, len(ranks) + 1)), "Models should have sequential ranks starting at 1"
    ...
    async def test_success_rates_valid_range(self):
        ...
        for provider in result.providers:
            ...
            assert 0 <= success_rate <= 1, f"Success rate {success_rate} out of valid range"
