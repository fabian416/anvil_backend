...
class TestCommandInteractorStructure:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="Implementation uses different Message constructor signature")
    async def test_send_message_execute_method_callable(self):
        ...
        result = await interactor.execute(conversation_id=conversation_id, content="Test message")
