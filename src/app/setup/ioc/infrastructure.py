...
from app.application.atlas.ports import (
    CityReader as AtlasCityReader,
    CountryReader as AtlasCountryReader,
)
...
class InfrastructureProvider(Provider):
    ...
    # Portfolio Repository (for portfolio snapshots persistence)
    portfolio_repo = provide(
        source=SqlaPortfolioRepository,
    ...
    def get_portfolio_service(
        ...
        """
        Provide Portfolio Service for calculating and managing portfolios.

        This service:
        - Fetches on-chain balances via RPC
        - Resolves USD prices via DeFiLlama
        - Creates and stores portfolio snapshots
        """
        # TODO: Read use_testnet from config
        import os
