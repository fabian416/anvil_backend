...
class SimulationResult(BaseModel):
    ...
    output_amount: Optional[str] = Field(default=None, description="Expected output amount")
    price_impact: Optional[float] = Field(default=None, description="Price impact percent")
