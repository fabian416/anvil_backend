...
router.include_router(
    providers_router, prefix="/providers", tags=["Admin - LLM Providers"]
)
router.include_router(models_router, prefix="/models", tags=["Admin - LLM Models"])
router.include_router(
    ranking_router, tags=["Admin - LLM Rankings"]
)  # Already has /rankings prefix
router.include_router(
    telemetry_router, prefix="/telemetry", tags=["Admin - LLM Telemetry"]
)
