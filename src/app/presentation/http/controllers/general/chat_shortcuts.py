    ...
    "en": {
        ...
        "shortcuts": [
            ...
            },
            {
                "intent": "swap",
                "command": "Swap",
                "description": "Exchange tokens via 1inch, LiFi, Hyperliquid, or MoonPay",
                "examples": [
    ...
    "es": {
        ...
        "shortcuts": [
            ...
            },
            {
                ...
                "description": "Intercambiar tokens vía 1inch, LiFi, Hyperliquid o MoonPay",
                "examples": [
                    ...
                    "Cambiar BTC por ETH",
                    "Cambiar BTC por SOL",
                    "Cambiar BTC por USDC",
                    "Cambiar ETH por BTC",
                    "Cambiar ETH por SOL",
                    "Cambiar ETH por USDC",
                    "Cambiar SOL por BTC",
                    "Cambiar SOL por ETH",
                    "Cambiar SOL por USDC",
                    "Cambiar USDC por BTC",
                    "Cambiar USDC por ETH",
                    "Cambiar USDC por SOL",
                ],
                "icon": "🔄",
            },
            {
    ...
    "fr": {
        ...
        "shortcuts": [
            ...
            },
            {
                "intent": "swap",
                "command": "Échanger",
                "description": "Échanger des tokens via 1inch, LiFi, Hyperliquid ou MoonPay",
                "examples": [
                    ...
                    "Échanger BTC contre SOL",
                    "Échanger BTC contre USDC",
                    "Échanger ETH contre BTC",
                    "Échanger ETH contre SOL",
                    "Échanger ETH contre USDC",
                    "Échanger SOL contre BTC",
                    "Échanger SOL contre ETH",
                    "Échanger SOL contre USDC",
                    "Échanger USDC contre BTC",
                    "Échanger USDC contre ETH",
                    "Échanger USDC contre SOL",
                ],
                "icon": "🔄",
            },
            {
    ...
    "zh": {
        ...
        "shortcuts": [
            ...
            },
            {
                "intent": "swap",
                "command": "交换",
                "description": "通过1inch、LiFi、Hyperliquid或MoonPay交换代币",
                "examples": [
                    "将100 USDC换成ETH",
                    "交换USDC从以太坊到Base",
                    "ETH换USDC最佳汇率",
    ...
    "pt": {
        ...
        "shortcuts": [
            ...
            },
            {
                "intent": "swap",
                "command": "Trocar",
                "description": "Trocar tokens via 1inch, LiFi, Hyperliquid ou MoonPay",
                "examples": [
