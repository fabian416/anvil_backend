...
class SendMessageWithDistillation:
    ...
    async def execute(
        ...
        if distillation_result.route_type == RouteType.REJECT:
            ...
            agent_response = self._get_rejection_message(
                distillation_result.rejection_reason
            )
        ...
        elif distillation_result.route_type in [
            RouteType.LIGHT_LLM,
            RouteType.FULL_LLM,
        ]:
            ...
            await self._distillation_engine.cache_response(
                ...
                entities=distillation_result.entities.__dict__
                if hasattr(distillation_result.entities, "__dict__")
                else {},
        ...
        agent_message = Message.create_agent_message(
            ...
            metadata={
                "distillation": {
                    ...
                    "estimated_cost_saved_usd": str(
                        distillation_result.estimated_cost_saved_usd
                    ),
                }
            },
        )
