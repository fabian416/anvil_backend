...
from app.domain.value_objects.perpetual.risk_metrics import RiskMetrics, assess_risk_level
...
class HyperliquidAdapter(PerpetualGateway):
    ...
    async def get_liquidations(
        ...
        cached = await self._cache.get("hyperliquid", "liquidations", **cache_key_params)
        if cached:
