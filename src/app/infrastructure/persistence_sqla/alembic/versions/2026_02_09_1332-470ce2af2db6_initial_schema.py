...
Revision ID: 470ce2af2db6
Revises:
Create Date: 2026-02-09 13:32:35.037262
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "protocol",
            postgresql.ENUM("aave", "morpho", name="protocol_enum", create_type=False),
            nullable=False,
        ),
        ...
        sa.Column(
            "position_type",
            postgresql.ENUM(
                "supply", "borrow", name="position_type_enum", create_type=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "open", "closed", "liquidated", name="positionstatus", create_type=False
            ),
            nullable=True,
        ),
