...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('include_code_examples', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('include_references', sa.Boolean(), nullable=False, server_default='true'),

        # Notification preferences
        sa.Column('notification_conversation_updates', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('notification_agent_responses', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('notification_daily_summary', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('notification_insight_alerts', sa.Boolean(), nullable=False, server_default='true'),

        # Display preferences
        sa.Column('display_theme', sa.String(20), nullable=False, server_default='light'),
        sa.Column('display_font_size', sa.Integer(), nullable=False, server_default='14'),
        sa.Column('display_show_timestamps', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('display_show_agent_names', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('display_markdown_rendering', sa.Boolean(), nullable=False, server_default='true'),
    ...
    op.create_index('idx_templates_creator', 'conversation_templates', ['created_by_user_id'])
    ...
    op.create_table(
        ...
        sa.Column('include_timestamps', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('include_agent_names', sa.Boolean(), nullable=False, server_default='true'),
    ...
    op.create_index('idx_exports_conversation', 'conversation_exports', ['conversation_id'])
    ...
    op.create_table(
        ...
        sa.Column('winning_vote_count', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('total_votes', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('consensus_confidence', sa.Float(), nullable=False, server_default='0.0'),
    ...
    op.create_table(
        ...
        sa.Column('last_24h_requests', sa.Integer(), nullable=False, server_default='0'),
    ...
    op.create_index('idx_agent_metrics_updated', 'agent_performance_metrics', [sa.text('updated_at DESC')])
    ...
    op.create_table(
        ...
        # LLM settings
        sa.Column('preferred_llm_provider', sa.String(50), nullable=False, server_default='openai'),
    ...
    op.create_index('idx_custom_agents_creator', 'custom_agent_configs', ['created_by_user_id'])
