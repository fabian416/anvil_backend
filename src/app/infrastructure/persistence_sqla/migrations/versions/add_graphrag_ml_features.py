...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('preferred_categories', postgresql.JSONB, nullable=False, default='[]'),
        ...
        sa.Column('notification_settings', postgresql.JSONB, nullable=False, default='{}'),
    ...
    op.create_table(
        ...
        sa.Column('protocol_id', postgresql.UUID(as_uuid=True), nullable=False, index=True),
        sa.Column('protocol_name', sa.String(200), nullable=False),
        sa.Column('chain', sa.String(50), nullable=False),
        sa.Column('position_type', sa.String(50), nullable=False),  # supplied, borrowed, lp, staked
    ...
    op.create_index('idx_protocol_exposures_portfolio_id', 'protocol_exposures', ['portfolio_id'])
    op.create_index('idx_protocol_exposures_protocol_id', 'protocol_exposures', ['protocol_id'])
    op.create_foreign_key(
        'fk_protocol_exposures_portfolio',
        'protocol_exposures', 'user_portfolios',
        ['portfolio_id'], ['id'],
        ondelete='CASCADE'
    )
    ...
    op.create_table(
        ...
        sa.Column('protocol_id', postgresql.UUID(as_uuid=True), nullable=False, index=True),
        sa.Column('protocol_name', sa.String(200), nullable=False),
        sa.Column('alert_type', sa.String(50), nullable=False),  # risk_increase, anomaly, critical, dependency
    ...
    op.create_table(
        ...
        sa.Column('protocol_update_alerts_enabled', sa.Boolean, nullable=False, default=True),
        ...
        sa.Column('subscribed_protocols', postgresql.JSONB, nullable=False, default='[]'),
        sa.Column('excluded_protocols', postgresql.JSONB, nullable=False, default='[]'),
    ...
    op.create_index('idx_alert_subscriptions_user_id', 'alert_subscriptions', ['user_id'])
    ...
    op.create_table(
        ...
        sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False, index=True),
        sa.Column('query', sa.Text, nullable=False),
        sa.Column('search_type', sa.String(50), nullable=False),  # hybrid, similar, contextual
        sa.Column('filters', postgresql.JSONB, nullable=False, default='{}'),
