...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('embedding', postgresql.ARRAY(sa.Float), nullable=False),  # Vector embedding
    ...
    op.create_table(
        ...
        sa.Column('entity_type', sa.String(50), nullable=False),  # 'Token', 'Chain', etc.
...
def downgrade() -> None:
    ...
    # Drop functions
    op.execute("DROP FUNCTION IF EXISTS find_similar_protocols(float[], float, integer)")
