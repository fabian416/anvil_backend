...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_distillation_telemetry_user_id", "distillation_telemetry", ["user_id"]
    )
    op.create_index(
        "idx_distillation_telemetry_success", "distillation_telemetry", ["success"]
    )
    op.create_index(
        "idx_distillation_telemetry_provider", "distillation_telemetry", ["provider"]
    )
    op.create_index(
