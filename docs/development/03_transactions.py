...
class Transaction(Base):
    ...
    dex_aggregator: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="DEX aggregator used (e.g., '1inch', '0x')"
    )
    dex_route: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="JSON: Route taken through DEX pools"
    )
    ...
    protocol: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="DeFi protocol (e.g., 'aave', 'compound')"
    )
    protocol_action: Mapped[Optional[str]] = mapped_column(
        String(20),
        nullable=True,
        comment="'deposit', 'withdraw', 'claim'"
    )
    ...
    metadata_json: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="JSON: Additional transaction metadata"
    )
...
class FundingTransaction(Base):
    ...
    amount_fiat: Mapped[Decimal] = mapped_column(
        Numeric(12, 2),
        nullable=False,
        comment="Amount in fiat currency (e.g., USD)"
    )
    ...
    amount_crypto: Mapped[Decimal] = mapped_column(
        Numeric(36, 18),
        nullable=False,
        comment="Amount of crypto purchased"
    )
