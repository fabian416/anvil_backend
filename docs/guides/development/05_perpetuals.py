...
class HyperliquidPosition(Base):
    ...
    base_asset: Mapped[str] = mapped_column(
        String(20), nullable=False, comment="Base asset (e.g., 'ETH', 'BTC')"
    )
    ...
    leverage: Mapped[Decimal] = mapped_column(
        Numeric(8, 2), nullable=False, comment="Leverage multiplier (e.g., 5.0 for 5x)"
    )
    size: Mapped[Decimal] = mapped_column(
        Numeric(36, 18), nullable=False, comment="Position size in base asset"
    )

    # Pricing
    entry_price: Mapped[Decimal] = mapped_column(
        Numeric(20, 8), nullable=False, comment="Average entry price"
    )
    exit_price: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(20, 8), nullable=True, comment="Exit price (when closed)"
    )
    ...
    liquidation_price: Mapped[Decimal] = mapped_column(
        Numeric(20, 8), nullable=False, comment="Liquidation price"
    )

    # Margin
    margin: Mapped[Decimal] = mapped_column(
        Numeric(20, 8), nullable=False, comment="Initial margin (collateral) in USDC"
    )
    ...
    last_funding_payment: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(20, 8), nullable=True, comment="Last funding payment amount"
    )
    last_funding_time: Mapped[Optional[datetime]] = mapped_column(
        DateTime, nullable=True, comment="Last funding payment timestamp"
    )
    ...
    metadata_json: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, comment="JSON: Additional Hyperliquid data"
    )
    ...
    liquidated_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
...
class HyperliquidOrder(Base):
    ...
    size: Mapped[Decimal] = mapped_column(
        Numeric(36, 18), nullable=False, comment="Order size"
    )
    price: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(20, 8), nullable=True, comment="Limit price (null for market orders)"
    )

    # Fill Information
    filled_size: Mapped[Decimal] = mapped_column(
        Numeric(36, 18), nullable=False, default=Decimal("0"), comment="Amount filled"
    )
    average_fill_price: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(20, 8), nullable=True, comment="Average price of fills"
    )
