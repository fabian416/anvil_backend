...
class Notification(Base):
    ...
    action_url: Mapped[Optional[str]] = mapped_column(
        String(500),
        nullable=True,
        comment="Deep link or URL for user action"
    )
    image_url: Mapped[Optional[str]] = mapped_column(
        String(500),
        nullable=True,
        comment="Optional image/icon URL"
    )
    ...
    expires_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime,
        nullable=True,
        comment="When notification expires (for in-app)"
    )
...
class NotificationPreference(Base):
    ...
    price_alerts: Mapped[bool] = mapped_column(
        ...
        nullable=False,
        default=True,
        comment="Price alerts and market updates"
    )
    ...
    quiet_hours_start: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        comment="Quiet hours start (0-23, user's timezone)"
    )
    quiet_hours_end: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        comment="Quiet hours end (0-23, user's timezone)"
    )
    ...
    daily_digest_enabled: Mapped[bool] = mapped_column(
        ...
        nullable=False,
        default=False,
        comment="Receive daily summary email"
    )
    daily_digest_time: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        comment="Time for daily digest (0-23, user's timezone)"
    )
