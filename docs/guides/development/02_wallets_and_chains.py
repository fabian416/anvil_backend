...
class Wallet(Base):
    ...
    metadata_json: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="JSON: Additional wallet metadata from Privy"
    )
    ...
    earn_positions = relationship("EarnPosition", back_populates="wallet", lazy="select")
    save_schedules = relationship("SaveSchedule", back_populates="wallet", lazy="select")
    hyperliquid_positions = relationship("HyperliquidPosition", back_populates="wallet", lazy="select")
    funding_transactions = relationship("FundingTransaction", back_populates="wallet", lazy="select")
...
class TokenBalance(Base):
    ...
    is_verified: Mapped[bool] = mapped_column(
        ...
        nullable=False,
        default=False,
        comment="Is token contract verified?"
    )
    ...
    # Indexes
    __table_args__ = (
        Index("idx_token_balance_chain_address", "chain_address_id", "contract_address"),
        ...
        Index("uq_chain_address_token", "chain_address_id", "contract_address", unique=True),
    )
