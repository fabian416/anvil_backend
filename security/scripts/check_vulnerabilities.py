...
class VulnerabilityChecker:
        ...
        try:
            ...
            for test_result in data.get('test_results', []):
                if test_result.get('vulnerable', False):
                    ...
                    severity = Severity.CRITICAL if 'script' in test_result.get('attack_vector', '').lower() else Severity.HIGH
    ...
    def _llm_category_to_severity(self, category: str) -> Severity:
        ...
        critical_categories = ['LLM01', 'LLM02', 'LLM03', 'LLM08']  # Prompt Injection, Insecure Output, Training Data Poisoning, Excessive Agency
